      ...
      <div className="max-w-sm w-full p-4 bg-white shadow-md rounded-lg">
        ...
        <div className="mt-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-base font-bold text-gray-800">Pratigya Kumari</h1>
              <p className=" text-xs text-gray-500 mb-1">@pratigyak</p>
            ...
            <button className="border-2 border-violet-950 px-3 py-1 rounded-full hover:bg-gray-200 flex items-center text-sm font-bold text-violet-950">
...
{   " Report incidents >"}
        ...
        <div className="mt-4">
          <div className="flex items-center">
            ...
            <p className="text-sm bg-gray-200 px-3 py-2 rounded-md flex-1">XXXXXX4875</p>
          </div>
          <div className="flex items-center mt-2">
            <FontAwesomeIcon icon={faEnvelope} className="h-5 w-5 text-gray-700 mr-2" />
            <p className="text-sm bg-gray-200 px-3 py-2 rounded-md flex-1">pratigyak01@gmail.com</p>
          </div>

          <div className="flex mt-1">
            <button className="text-violet-950 text-xs font-bold text-right flex-1 ">
              Verify mail
            </button>
          </div>
          <div className="flex items-center mt-2">
            <FontAwesomeIcon icon={faLock} className="h-5 w-5 text-gray-700 mr-2" />
            <p className="text-sm bg-gray-200 px-3 py-2 rounded-md flex-1">Password</p>
          </div>
        </div>
        <div className="mt-4">
